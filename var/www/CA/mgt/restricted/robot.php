...
Please, fill <b>all</b> the fields of the form</center>";
     ...
     if (ereg($regx, $L)) {
         echo
"<FONT COLOR=red><center><h3>The string is not correct</h3></font>
Please, retry again";
        include("/var/www/CA/phpinc/bottom.inc");
        exit;
     }
...
Please, retry again";
     ...
     if (!$email_verify) {
         echo
"<FONT COLOR=red><center><h3>The string is not correct</h3></center></font>
Please, retype again";
        include("/var/www/CA/phpinc/bottom.inc");
        exit;
     }
...
<TR>
<TD ALIGN=RIGHT><b>Purpose of robot: </TD>
